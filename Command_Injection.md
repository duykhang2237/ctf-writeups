...
## VD 1: https://battle.cookiearena.org/challenges/web/baby-ping
...
## VD 2: https://battle.cookiearena.org/challenges/web/baby-crawler
- ta có đoạn mã sau:
  ```php
  if(isset($_POST['url'])){
  $url = $_POST['url'];
...
## VD3: http://battle.cookiearena.org/skills-path/os-command-injection/challenge/command-limit-length
