...
#### Trường Hợp 2
Nếu bạn upload file .php lên thì nó vẫn cho upload lên nhưng khi truy cập vào thì nó hiển thị ra code php, có khả năng là direction ở đó bị mã hóa, ta có thể thử upload đường dẫn ngoài vd từ /files/upload/shell.php thì ta có thể dẫn đến /files/shell.php bằng `filename="..%2fshell.php"`
#### Trường Hợp 3
Bắt đầu dev có nhận thức về security thì họ sẽ có thể sử dụng backlist để không cho chúng ta upload file đuôi php lên chẵn hạn
